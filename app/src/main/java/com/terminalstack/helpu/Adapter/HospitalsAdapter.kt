...
import com.terminalstack.helpu.dataClass.HospitalsItem
import com.terminalstack.helpu.dataClass.ToiletsItem

class HospitalsAdapter () :
    RecyclerView.Adapter<HospitalsAdapter.RestroViewHolder>() {

    var restro = mutableListOf<HospitalsItem>()
    ...
    @JvmName("setRestro1")
    fun setRestro(restro : List<HospitalsItem>) {

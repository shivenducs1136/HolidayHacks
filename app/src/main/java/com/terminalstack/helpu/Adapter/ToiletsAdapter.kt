...
import com.terminalstack.helpu.dataClass.MallsItem
import com.terminalstack.helpu.dataClass.ToiletsItem

class ToiletsAdapter () :
    RecyclerView.Adapter<ToiletsAdapter.RestroViewHolder>() {

    var restro = mutableListOf<ToiletsItem>()
    ...
    @JvmName("setRestro1")
    fun setRestro(restro : List<ToiletsItem>) {
